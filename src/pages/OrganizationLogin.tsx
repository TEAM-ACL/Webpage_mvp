...
export default function OrganizationLogin(): JSX.Element {
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md">
          <div className="bg-white/70 backdrop-blur-3xl rounded-[2rem] p-8 md:p-12 shadow-2xl border border-white/20">
            <div className="mb-10 text-left">
              <h1 className="font-headline text-4xl font-bold tracking-tight text-on-surface mb-3">Organization Login</h1>
              <p className="text-on-surface-variant font-sans opacity-70 leading-relaxed">
                Sign in to manage organization opportunities and workflows.
              </p>
            </div>

            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <label className="font-label text-xs font-semibold uppercase tracking-wider text-on-surface-variant ml-1">Work Email</label>
            ...
            <p className="mt-6 text-sm text-on-surface-variant">
              New organization?{" "}
              <Link to="/organization-signup" className="font-semibold text-primary hover:underline">
