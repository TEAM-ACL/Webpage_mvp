...
export default function OnboardingWalkthroughSlideshow(): JSX.Element {
  ...
  return (
    <section className="border-t border-slate-200 bg-white px-6 py-20 md:px-12 lg:px-16">
      <div className="mx-auto max-w-6xl space-y-10">
        ...
        <div className="rounded-3xl border border-[#d8cffc] bg-[#f9f6ff] p-4 shadow-sm md:p-6">
